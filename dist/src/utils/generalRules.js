...
exports.generalRules = {
    ...
    my_headers: {
        ...
        'cdn-loop': joi_1.default.string().optional(),
        'cf-connecting-ip': joi_1.default.string().optional(),
        'cf-ipcountry': joi_1.default.string().optional(),
        'cf-ray': joi_1.default.string().optional(),
        'cf-visitor': joi_1.default.string().optional(),
        'render-proxy-ttl': joi_1.default.string().optional(),
        'rndr-id': joi_1.default.string().optional(),
        'true-client-ip': joi_1.default.string().optional(),
        'x-forwarded-for': joi_1.default.string().optional(),
        'x-forwarded-proto': joi_1.default.string().optional(),
        'x-request-start': joi_1.default.string().optional(),
    },
