...
productRoutes.get("/", (0, middleware_1.errorCatcher)((0, middleware_1.validationMiddleware)(product_schema_1.getUserProductSchema)), (0, middleware_1.errorCatcher)((0, middleware_1.verifyToken)((_b = process.env.LOGIN_SIGNATURE) !== null && _b !== void 0 ? _b : "")), (0, middleware_1.errorCatcher)(product_controller_1.getUserProduct));
